...
%     \item{} Rui Seabra -- Tesoureiro
%     \item{} André Esteves -- Vogal
%     \item{} Tiago Policarpo -- Vogal
%   \end{itemize}
% \end{slide}
% 
...
% \begin{slide}
% ANSOL -- Intervenções no meio político e legilativo
% \begin{itemize}
%   \item{} Interverções e elaboração de pareceres junto do Parlamento Português
%   \item{} Coordenação para trabalhos em âmbito Europeu
